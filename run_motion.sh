...
#   DATA_DIR     Work dir for clips (default: /Volumes/HP USB20FD/CCTV/motion/data)
#   MOTION_DB_DIR Source-of-truth motion DB dir (default: /Volumes/HP USB20FD/CCTV/recordings/esp_cam1)
#   CCTV_RECORDINGS_DIR Recording/DB dir (default: /Volumes/HP USB20FD/CCTV/recordings/esp_cam1)
...
DATA_DIR="${DATA_DIR:-/Volumes/HP USB20FD/CCTV/motion/data}"
MOTION_DB_DIR="${MOTION_DB_DIR:-/Volumes/HP USB20FD/CCTV/recordings/esp_cam1}"
CCTV_RECORDINGS_DIR="${CCTV_RECORDINGS_DIR:-/Volumes/HP USB20FD/CCTV/recordings/esp_cam1}"
